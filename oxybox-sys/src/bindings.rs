...
const _: () = {
    ...
    ["Offset of field: b2RayCastInput::origin"]
        [::std::mem::offset_of!(b2RayCastInput, origin) - 0usize];
    ["Offset of field: b2RayCastInput::translation"]
        [::std::mem::offset_of!(b2RayCastInput, translation) - 8usize];
    ["Offset of field: b2RayCastInput::maxFraction"]
        [::std::mem::offset_of!(b2RayCastInput, maxFraction) - 16usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2ShapeProxy::points"]
        [::std::mem::offset_of!(b2ShapeProxy, points) - 0usize];
    ["Offset of field: b2ShapeProxy::count"][::std::mem::offset_of!(b2ShapeProxy, count) - 64usize];
    ["Offset of field: b2ShapeProxy::radius"]
        [::std::mem::offset_of!(b2ShapeProxy, radius) - 68usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2ShapeCastInput::proxy"]
        [::std::mem::offset_of!(b2ShapeCastInput, proxy) - 0usize];
    ["Offset of field: b2ShapeCastInput::translation"]
        [::std::mem::offset_of!(b2ShapeCastInput, translation) - 72usize];
    ["Offset of field: b2ShapeCastInput::maxFraction"]
        [::std::mem::offset_of!(b2ShapeCastInput, maxFraction) - 80usize];
    ["Offset of field: b2ShapeCastInput::canEncroach"]
        [::std::mem::offset_of!(b2ShapeCastInput, canEncroach) - 84usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2CastOutput::normal"]
        [::std::mem::offset_of!(b2CastOutput, normal) - 0usize];
    ["Offset of field: b2CastOutput::point"][::std::mem::offset_of!(b2CastOutput, point) - 8usize];
    ["Offset of field: b2CastOutput::fraction"]
        [::std::mem::offset_of!(b2CastOutput, fraction) - 16usize];
    ["Offset of field: b2CastOutput::iterations"]
        [::std::mem::offset_of!(b2CastOutput, iterations) - 20usize];
...
const _: () = {
    ...
    ["Offset of field: b2MassData::rotationalInertia"]
        [::std::mem::offset_of!(b2MassData, rotationalInertia) - 12usize];
};
#[doc = " A solid circle"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: b2Polygon::centroid"]
        [::std::mem::offset_of!(b2Polygon, centroid) - 128usize];
...
const _: () = {
    ...
    ["Offset of field: b2ChainSegment::ghost1"]
        [::std::mem::offset_of!(b2ChainSegment, ghost1) - 0usize];
    ["Offset of field: b2ChainSegment::segment"]
        [::std::mem::offset_of!(b2ChainSegment, segment) - 8usize];
    ["Offset of field: b2ChainSegment::ghost2"]
        [::std::mem::offset_of!(b2ChainSegment, ghost2) - 24usize];
    ["Offset of field: b2ChainSegment::chainId"]
        [::std::mem::offset_of!(b2ChainSegment, chainId) - 32usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Alignment of b2SegmentDistanceResult"]
        [::std::mem::align_of::<b2SegmentDistanceResult>() - 4usize];
...
const _: () = {
    ...
    ["Offset of field: b2SimplexCache::count"]
        [::std::mem::offset_of!(b2SimplexCache, count) - 0usize];
    ["Offset of field: b2SimplexCache::indexA"]
        [::std::mem::offset_of!(b2SimplexCache, indexA) - 2usize];
    ["Offset of field: b2SimplexCache::indexB"]
        [::std::mem::offset_of!(b2SimplexCache, indexB) - 5usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2DistanceInput::proxyA"]
        [::std::mem::offset_of!(b2DistanceInput, proxyA) - 0usize];
    ["Offset of field: b2DistanceInput::proxyB"]
        [::std::mem::offset_of!(b2DistanceInput, proxyB) - 72usize];
    ["Offset of field: b2DistanceInput::transformA"]
        [::std::mem::offset_of!(b2DistanceInput, transformA) - 144usize];
    ["Offset of field: b2DistanceInput::transformB"]
        [::std::mem::offset_of!(b2DistanceInput, transformB) - 160usize];
    ["Offset of field: b2DistanceInput::useRadii"]
        [::std::mem::offset_of!(b2DistanceInput, useRadii) - 176usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2DistanceOutput::pointA"]
        [::std::mem::offset_of!(b2DistanceOutput, pointA) - 0usize];
    ["Offset of field: b2DistanceOutput::pointB"]
        [::std::mem::offset_of!(b2DistanceOutput, pointB) - 8usize];
    ["Offset of field: b2DistanceOutput::normal"]
        [::std::mem::offset_of!(b2DistanceOutput, normal) - 16usize];
    ["Offset of field: b2DistanceOutput::distance"]
        [::std::mem::offset_of!(b2DistanceOutput, distance) - 24usize];
    ["Offset of field: b2DistanceOutput::iterations"]
        [::std::mem::offset_of!(b2DistanceOutput, iterations) - 28usize];
...
const _: () = {
    ...
    ["Offset of field: b2SimplexVertex::indexA"]
        [::std::mem::offset_of!(b2SimplexVertex, indexA) - 28usize];
    ["Offset of field: b2SimplexVertex::indexB"]
        [::std::mem::offset_of!(b2SimplexVertex, indexB) - 32usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2ShapeCastPairInput::proxyA"]
        [::std::mem::offset_of!(b2ShapeCastPairInput, proxyA) - 0usize];
    ["Offset of field: b2ShapeCastPairInput::proxyB"]
        [::std::mem::offset_of!(b2ShapeCastPairInput, proxyB) - 72usize];
...
const _: () = {
    ...
    ["Offset of field: b2Sweep::localCenter"]
        [::std::mem::offset_of!(b2Sweep, localCenter) - 0usize];
...
const _: () = {
    ...
    ["Offset of field: b2TOIInput::maxFraction"]
        [::std::mem::offset_of!(b2TOIInput, maxFraction) - 224usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2TOIOutput::fraction"]
        [::std::mem::offset_of!(b2TOIOutput, fraction) - 20usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2ManifoldPoint::point"]
        [::std::mem::offset_of!(b2ManifoldPoint, point) - 0usize];
    ["Offset of field: b2ManifoldPoint::anchorA"]
        [::std::mem::offset_of!(b2ManifoldPoint, anchorA) - 8usize];
    ["Offset of field: b2ManifoldPoint::anchorB"]
        [::std::mem::offset_of!(b2ManifoldPoint, anchorB) - 16usize];
    ["Offset of field: b2ManifoldPoint::separation"]
        [::std::mem::offset_of!(b2ManifoldPoint, separation) - 24usize];
    ...
    ["Offset of field: b2ManifoldPoint::persisted"]
        [::std::mem::offset_of!(b2ManifoldPoint, persisted) - 46usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2Manifold::rollingImpulse"]
        [::std::mem::offset_of!(b2Manifold, rollingImpulse) - 8usize];
    ["Offset of field: b2Manifold::points"][::std::mem::offset_of!(b2Manifold, points) - 12usize];
    ["Offset of field: b2Manifold::pointCount"]
        [::std::mem::offset_of!(b2Manifold, pointCount) - 108usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2DynamicTree::nodes"]
        [::std::mem::offset_of!(b2DynamicTree, nodes) - 0usize];
    ["Offset of field: b2DynamicTree::root"][::std::mem::offset_of!(b2DynamicTree, root) - 8usize];
    ["Offset of field: b2DynamicTree::nodeCount"]
        [::std::mem::offset_of!(b2DynamicTree, nodeCount) - 12usize];
    ["Offset of field: b2DynamicTree::nodeCapacity"]
        [::std::mem::offset_of!(b2DynamicTree, nodeCapacity) - 16usize];
    ["Offset of field: b2DynamicTree::freeList"]
        [::std::mem::offset_of!(b2DynamicTree, freeList) - 20usize];
    ["Offset of field: b2DynamicTree::proxyCount"]
        [::std::mem::offset_of!(b2DynamicTree, proxyCount) - 24usize];
    ["Offset of field: b2DynamicTree::leafIndices"]
        [::std::mem::offset_of!(b2DynamicTree, leafIndices) - 32usize];
    ["Offset of field: b2DynamicTree::leafBoxes"]
        [::std::mem::offset_of!(b2DynamicTree, leafBoxes) - 40usize];
    ["Offset of field: b2DynamicTree::leafCenters"]
        [::std::mem::offset_of!(b2DynamicTree, leafCenters) - 48usize];
    ["Offset of field: b2DynamicTree::binIndices"]
        [::std::mem::offset_of!(b2DynamicTree, binIndices) - 56usize];
...
const _: () = {
    ...
    ["Offset of field: b2TreeStats::nodeVisits"]
        [::std::mem::offset_of!(b2TreeStats, nodeVisits) - 0usize];
    ["Offset of field: b2TreeStats::leafVisits"]
        [::std::mem::offset_of!(b2TreeStats, leafVisits) - 4usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2PlaneResult::plane"]
        [::std::mem::offset_of!(b2PlaneResult, plane) - 0usize];
    ["Offset of field: b2PlaneResult::point"]
        [::std::mem::offset_of!(b2PlaneResult, point) - 12usize];
...
const _: () = {
    ...
    ["Offset of field: b2CollisionPlane::plane"]
        [::std::mem::offset_of!(b2CollisionPlane, plane) - 0usize];
    ["Offset of field: b2CollisionPlane::pushLimit"]
        [::std::mem::offset_of!(b2CollisionPlane, pushLimit) - 12usize];
    ["Offset of field: b2CollisionPlane::push"]
        [::std::mem::offset_of!(b2CollisionPlane, push) - 16usize];
...
const _: () = {
    ...
    ["Offset of field: b2WorldId::generation"]
        [::std::mem::offset_of!(b2WorldId, generation) - 2usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2BodyId::generation"]
        [::std::mem::offset_of!(b2BodyId, generation) - 6usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2ShapeId::generation"]
        [::std::mem::offset_of!(b2ShapeId, generation) - 6usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2ChainId::generation"]
        [::std::mem::offset_of!(b2ChainId, generation) - 6usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2JointId::generation"]
        [::std::mem::offset_of!(b2JointId, generation) - 6usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2ContactId::padding"]
        [::std::mem::offset_of!(b2ContactId, padding) - 6usize];
    ["Offset of field: b2ContactId::generation"]
        [::std::mem::offset_of!(b2ContactId, generation) - 8usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2RayResult::shapeId"]
        [::std::mem::offset_of!(b2RayResult, shapeId) - 0usize];
    ...
    ["Offset of field: b2RayResult::fraction"]
        [::std::mem::offset_of!(b2RayResult, fraction) - 24usize];
    ["Offset of field: b2RayResult::nodeVisits"]
        [::std::mem::offset_of!(b2RayResult, nodeVisits) - 28usize];
    ["Offset of field: b2RayResult::leafVisits"]
        [::std::mem::offset_of!(b2RayResult, leafVisits) - 32usize];
...
const _: () = {
    ...
    ["Offset of field: b2WorldDef::hitEventThreshold"]
        [::std::mem::offset_of!(b2WorldDef, hitEventThreshold) - 12usize];
    ["Offset of field: b2WorldDef::contactHertz"]
        [::std::mem::offset_of!(b2WorldDef, contactHertz) - 16usize];
    ["Offset of field: b2WorldDef::contactDampingRatio"]
        [::std::mem::offset_of!(b2WorldDef, contactDampingRatio) - 20usize];
    ["Offset of field: b2WorldDef::contactSpeed"]
        [::std::mem::offset_of!(b2WorldDef, contactSpeed) - 24usize];
    ["Offset of field: b2WorldDef::maximumLinearSpeed"]
        [::std::mem::offset_of!(b2WorldDef, maximumLinearSpeed) - 28usize];
    ["Offset of field: b2WorldDef::frictionCallback"]
        [::std::mem::offset_of!(b2WorldDef, frictionCallback) - 32usize];
    ["Offset of field: b2WorldDef::restitutionCallback"]
        [::std::mem::offset_of!(b2WorldDef, restitutionCallback) - 40usize];
    ["Offset of field: b2WorldDef::enableSleep"]
        [::std::mem::offset_of!(b2WorldDef, enableSleep) - 48usize];
    ["Offset of field: b2WorldDef::enableContinuous"]
        [::std::mem::offset_of!(b2WorldDef, enableContinuous) - 49usize];
    ["Offset of field: b2WorldDef::workerCount"]
        [::std::mem::offset_of!(b2WorldDef, workerCount) - 52usize];
    ["Offset of field: b2WorldDef::enqueueTask"]
        [::std::mem::offset_of!(b2WorldDef, enqueueTask) - 56usize];
    ["Offset of field: b2WorldDef::finishTask"]
        [::std::mem::offset_of!(b2WorldDef, finishTask) - 64usize];
    ["Offset of field: b2WorldDef::userTaskContext"]
        [::std::mem::offset_of!(b2WorldDef, userTaskContext) - 72usize];
    ["Offset of field: b2WorldDef::userData"]
        [::std::mem::offset_of!(b2WorldDef, userData) - 80usize];
    ["Offset of field: b2WorldDef::internalValue"]
        [::std::mem::offset_of!(b2WorldDef, internalValue) - 88usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2MotionLocks::linearX"]
        [::std::mem::offset_of!(b2MotionLocks, linearX) - 0usize];
    ["Offset of field: b2MotionLocks::linearY"]
        [::std::mem::offset_of!(b2MotionLocks, linearY) - 1usize];
    ["Offset of field: b2MotionLocks::angularZ"]
        [::std::mem::offset_of!(b2MotionLocks, angularZ) - 2usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2BodyDef::linearVelocity"]
        [::std::mem::offset_of!(b2BodyDef, linearVelocity) - 20usize];
    ["Offset of field: b2BodyDef::angularVelocity"]
        [::std::mem::offset_of!(b2BodyDef, angularVelocity) - 28usize];
    ["Offset of field: b2BodyDef::linearDamping"]
        [::std::mem::offset_of!(b2BodyDef, linearDamping) - 32usize];
    ["Offset of field: b2BodyDef::angularDamping"]
        [::std::mem::offset_of!(b2BodyDef, angularDamping) - 36usize];
    ["Offset of field: b2BodyDef::gravityScale"]
        [::std::mem::offset_of!(b2BodyDef, gravityScale) - 40usize];
    ["Offset of field: b2BodyDef::sleepThreshold"]
        [::std::mem::offset_of!(b2BodyDef, sleepThreshold) - 44usize];
    ...
    ["Offset of field: b2BodyDef::motionLocks"]
        [::std::mem::offset_of!(b2BodyDef, motionLocks) - 64usize];
    ["Offset of field: b2BodyDef::enableSleep"]
        [::std::mem::offset_of!(b2BodyDef, enableSleep) - 67usize];
    ...
    ["Offset of field: b2BodyDef::isEnabled"]
        [::std::mem::offset_of!(b2BodyDef, isEnabled) - 70usize];
    ["Offset of field: b2BodyDef::allowFastRotation"]
        [::std::mem::offset_of!(b2BodyDef, allowFastRotation) - 71usize];
    ["Offset of field: b2BodyDef::internalValue"]
        [::std::mem::offset_of!(b2BodyDef, internalValue) - 72usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2Filter::categoryBits"]
        [::std::mem::offset_of!(b2Filter, categoryBits) - 0usize];
    ["Offset of field: b2Filter::maskBits"][::std::mem::offset_of!(b2Filter, maskBits) - 8usize];
    ["Offset of field: b2Filter::groupIndex"]
        [::std::mem::offset_of!(b2Filter, groupIndex) - 16usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2QueryFilter::categoryBits"]
        [::std::mem::offset_of!(b2QueryFilter, categoryBits) - 0usize];
    ["Offset of field: b2QueryFilter::maskBits"]
        [::std::mem::offset_of!(b2QueryFilter, maskBits) - 8usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2SurfaceMaterial::friction"]
        [::std::mem::offset_of!(b2SurfaceMaterial, friction) - 0usize];
...
const _: () = {
    ...
    ["Offset of field: b2ShapeDef::userData"]
        [::std::mem::offset_of!(b2ShapeDef, userData) - 0usize];
    ["Offset of field: b2ShapeDef::material"]
        [::std::mem::offset_of!(b2ShapeDef, material) - 8usize];
    ...
    ["Offset of field: b2ShapeDef::isSensor"]
        [::std::mem::offset_of!(b2ShapeDef, isSensor) - 73usize];
    ...
    ["Offset of field: b2ShapeDef::enableHitEvents"]
        [::std::mem::offset_of!(b2ShapeDef, enableHitEvents) - 76usize];
    ...
    ["Offset of field: b2ShapeDef::updateBodyMass"]
        [::std::mem::offset_of!(b2ShapeDef, updateBodyMass) - 79usize];
    ["Offset of field: b2ShapeDef::internalValue"]
        [::std::mem::offset_of!(b2ShapeDef, internalValue) - 80usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2ChainDef::userData"]
        [::std::mem::offset_of!(b2ChainDef, userData) - 0usize];
    ...
    ["Offset of field: b2ChainDef::materials"]
        [::std::mem::offset_of!(b2ChainDef, materials) - 24usize];
    ["Offset of field: b2ChainDef::materialCount"]
        [::std::mem::offset_of!(b2ChainDef, materialCount) - 32usize];
    ...
    ["Offset of field: b2ChainDef::internalValue"]
        [::std::mem::offset_of!(b2ChainDef, internalValue) - 68usize];
};
extern "C" {
...
const _: () = {
    ...
    ["Offset of field: b2Profile::prepareStages"]
        [::std::mem::offset_of!(b2Profile, prepareStages) - 16usize];
    ["Offset of field: b2Profile::solveConstraints"]
        [::std::mem::offset_of!(b2Profile, solveConstraints) - 20usize];
    ["Offset of field: b2Profile::prepareConstraints"]
        [::std::mem::offset_of!(b2Profile, prepareConstraints) - 24usize];
    ["Offset of field: b2Profile::integrateVelocities"]
        [::std::mem::offset_of!(b2Profile, integrateVelocities) - 28usize];
    ["Offset of field: b2Profile::warmStart"]
        [::std::mem::offset_of!(b2Profile, warmStart) - 32usize];
    ["Offset of field: b2Profile::solveImpulses"]
        [::std::mem::offset_of!(b2Profile, solveImpulses) - 36usize];
    ["Offset of field: b2Profile::integratePositions"]
        [::std::mem::offset_of!(b2Profile, integratePositions) - 40usize];
    ["Offset of field: b2Profile::relaxImpulses"]
        [::std::mem::offset_of!(b2Profile, relaxImpulses) - 44usize];
    ["Offset of field: b2Profile::applyRestitution"]
        [::std::mem::offset_of!(b2Profile, applyRestitution) - 48usize];
    ["Offset of field: b2Profile::storeImpulses"]
        [::std::mem::offset_of!(b2Profile, storeImpulses) - 52usize];
    ["Offset of field: b2Profile::splitIslands"]
        [::std::mem::offset_of!(b2Profile, splitIslands) - 56usize];
    ["Offset of field: b2Profile::transforms"]
        [::std::mem::offset_of!(b2Profile, transforms) - 60usize];
    ["Offset of field: b2Profile::sensorHits"]
        [::std::mem::offset_of!(b2Profile, sensorHits) - 64usize];
    ["Offset of field: b2Profile::jointEvents"]
        [::std::mem::offset_of!(b2Profile, jointEvents) - 68usize];
    ["Offset of field: b2Profile::hitEvents"]
        [::std::mem::offset_of!(b2Profile, hitEvents) - 72usize];
    ...
    ["Offset of field: b2Profile::sleepIslands"]
        [::std::mem::offset_of!(b2Profile, sleepIslands) - 84usize];
...
const _: () = {
    ...
    ["Offset of field: b2Counters::bodyCount"]
        [::std::mem::offset_of!(b2Counters, bodyCount) - 0usize];
    ["Offset of field: b2Counters::shapeCount"]
        [::std::mem::offset_of!(b2Counters, shapeCount) - 4usize];
    ["Offset of field: b2Counters::contactCount"]
        [::std::mem::offset_of!(b2Counters, contactCount) - 8usize];
    ["Offset of field: b2Counters::jointCount"]
        [::std::mem::offset_of!(b2Counters, jointCount) - 12usize];
    ["Offset of field: b2Counters::islandCount"]
        [::std::mem::offset_of!(b2Counters, islandCount) - 16usize];
    ["Offset of field: b2Counters::stackUsed"]
        [::std::mem::offset_of!(b2Counters, stackUsed) - 20usize];
    ["Offset of field: b2Counters::staticTreeHeight"]
        [::std::mem::offset_of!(b2Counters, staticTreeHeight) - 24usize];
    ["Offset of field: b2Counters::treeHeight"]
        [::std::mem::offset_of!(b2Counters, treeHeight) - 28usize];
    ["Offset of field: b2Counters::byteCount"]
        [::std::mem::offset_of!(b2Counters, byteCount) - 32usize];
    ["Offset of field: b2Counters::taskCount"]
        [::std::mem::offset_of!(b2Counters, taskCount) - 36usize];
    ["Offset of field: b2Counters::colorCounts"]
        [::std::mem::offset_of!(b2Counters, colorCounts) - 40usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2JointDef::userData"]
        [::std::mem::offset_of!(b2JointDef, userData) - 0usize];
    ...
    ["Offset of field: b2JointDef::localFrameA"]
        [::std::mem::offset_of!(b2JointDef, localFrameA) - 24usize];
    ["Offset of field: b2JointDef::localFrameB"]
        [::std::mem::offset_of!(b2JointDef, localFrameB) - 40usize];
    ["Offset of field: b2JointDef::forceThreshold"]
        [::std::mem::offset_of!(b2JointDef, forceThreshold) - 56usize];
    ["Offset of field: b2JointDef::torqueThreshold"]
        [::std::mem::offset_of!(b2JointDef, torqueThreshold) - 60usize];
    ["Offset of field: b2JointDef::constraintHertz"]
        [::std::mem::offset_of!(b2JointDef, constraintHertz) - 64usize];
    ["Offset of field: b2JointDef::constraintDampingRatio"]
        [::std::mem::offset_of!(b2JointDef, constraintDampingRatio) - 68usize];
    ["Offset of field: b2JointDef::drawScale"]
        [::std::mem::offset_of!(b2JointDef, drawScale) - 72usize];
    ["Offset of field: b2JointDef::collideConnected"]
        [::std::mem::offset_of!(b2JointDef, collideConnected) - 76usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2DistanceJointDef::base"]
        [::std::mem::offset_of!(b2DistanceJointDef, base) - 0usize];
    ["Offset of field: b2DistanceJointDef::length"]
        [::std::mem::offset_of!(b2DistanceJointDef, length) - 80usize];
    ...
    ["Offset of field: b2DistanceJointDef::hertz"]
        [::std::mem::offset_of!(b2DistanceJointDef, hertz) - 96usize];
...
const _: () = {
    ...
    ["Offset of field: b2MotorJointDef::base"]
        [::std::mem::offset_of!(b2MotorJointDef, base) - 0usize];
    ...
    ["Offset of field: b2MotorJointDef::linearHertz"]
        [::std::mem::offset_of!(b2MotorJointDef, linearHertz) - 100usize];
...
const _: () = {
    ...
    ["Offset of field: b2FilterJointDef::base"]
        [::std::mem::offset_of!(b2FilterJointDef, base) - 0usize];
...
const _: () = {
    ...
    ["Offset of field: b2PrismaticJointDef::base"]
        [::std::mem::offset_of!(b2PrismaticJointDef, base) - 0usize];
    ["Offset of field: b2PrismaticJointDef::enableSpring"]
        [::std::mem::offset_of!(b2PrismaticJointDef, enableSpring) - 80usize];
    ["Offset of field: b2PrismaticJointDef::hertz"]
        [::std::mem::offset_of!(b2PrismaticJointDef, hertz) - 84usize];
...
const _: () = {
    ...
    ["Offset of field: b2RevoluteJointDef::base"]
        [::std::mem::offset_of!(b2RevoluteJointDef, base) - 0usize];
    ...
    ["Offset of field: b2RevoluteJointDef::hertz"]
        [::std::mem::offset_of!(b2RevoluteJointDef, hertz) - 88usize];
...
const _: () = {
    ...
    ["Offset of field: b2WeldJointDef::base"]
        [::std::mem::offset_of!(b2WeldJointDef, base) - 0usize];
    ["Offset of field: b2WeldJointDef::linearHertz"]
        [::std::mem::offset_of!(b2WeldJointDef, linearHertz) - 80usize];
    ["Offset of field: b2WeldJointDef::angularHertz"]
        [::std::mem::offset_of!(b2WeldJointDef, angularHertz) - 84usize];
    ...
    ["Offset of field: b2WeldJointDef::internalValue"]
        [::std::mem::offset_of!(b2WeldJointDef, internalValue) - 96usize];
};
extern "C" {
    #[doc = " Use this to initialize your joint definition\n @ingroup weld_joint"]
...
const _: () = {
    ...
    ["Offset of field: b2WheelJointDef::base"]
        [::std::mem::offset_of!(b2WheelJointDef, base) - 0usize];
    ["Offset of field: b2WheelJointDef::enableSpring"]
        [::std::mem::offset_of!(b2WheelJointDef, enableSpring) - 80usize];
    ["Offset of field: b2WheelJointDef::hertz"]
        [::std::mem::offset_of!(b2WheelJointDef, hertz) - 84usize];
    ["Offset of field: b2WheelJointDef::dampingRatio"]
        [::std::mem::offset_of!(b2WheelJointDef, dampingRatio) - 88usize];
    ["Offset of field: b2WheelJointDef::enableLimit"]
        [::std::mem::offset_of!(b2WheelJointDef, enableLimit) - 92usize];
    ...
    ["Offset of field: b2WheelJointDef::enableMotor"]
        [::std::mem::offset_of!(b2WheelJointDef, enableMotor) - 104usize];
    ["Offset of field: b2WheelJointDef::maxMotorTorque"]
        [::std::mem::offset_of!(b2WheelJointDef, maxMotorTorque) - 108usize];
    ["Offset of field: b2WheelJointDef::motorSpeed"]
        [::std::mem::offset_of!(b2WheelJointDef, motorSpeed) - 112usize];
...
const _: () = {
    ...
    ["Offset of field: b2ExplosionDef::maskBits"]
        [::std::mem::offset_of!(b2ExplosionDef, maskBits) - 0usize];
    ["Offset of field: b2ExplosionDef::position"]
        [::std::mem::offset_of!(b2ExplosionDef, position) - 8usize];
    ["Offset of field: b2ExplosionDef::radius"]
        [::std::mem::offset_of!(b2ExplosionDef, radius) - 16usize];
    ["Offset of field: b2ExplosionDef::falloff"]
        [::std::mem::offset_of!(b2ExplosionDef, falloff) - 20usize];
...
const _: () = {
    ...
    ["Alignment of b2SensorBeginTouchEvent"]
        [::std::mem::align_of::<b2SensorBeginTouchEvent>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of b2SensorEndTouchEvent"]
        [::std::mem::align_of::<b2SensorEndTouchEvent>() - 4usize];
...
const _: () = {
    ...
    ["Offset of field: b2SensorEvents::beginEvents"]
        [::std::mem::offset_of!(b2SensorEvents, beginEvents) - 0usize];
    ["Offset of field: b2SensorEvents::endEvents"]
        [::std::mem::offset_of!(b2SensorEvents, endEvents) - 8usize];
    ["Offset of field: b2SensorEvents::beginCount"]
        [::std::mem::offset_of!(b2SensorEvents, beginCount) - 16usize];
    ["Offset of field: b2SensorEvents::endCount"]
        [::std::mem::offset_of!(b2SensorEvents, endCount) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of b2ContactBeginTouchEvent"]
        [::std::mem::size_of::<b2ContactBeginTouchEvent>() - 28usize];
    ["Alignment of b2ContactBeginTouchEvent"]
        [::std::mem::align_of::<b2ContactBeginTouchEvent>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of b2ContactEndTouchEvent"]
        [::std::mem::align_of::<b2ContactEndTouchEvent>() - 4usize];
...
const _: () = {
    ...
    ["Offset of field: b2ContactHitEvent::shapeIdA"]
        [::std::mem::offset_of!(b2ContactHitEvent, shapeIdA) - 0usize];
    ["Offset of field: b2ContactHitEvent::shapeIdB"]
        [::std::mem::offset_of!(b2ContactHitEvent, shapeIdB) - 8usize];
    ["Offset of field: b2ContactHitEvent::point"]
        [::std::mem::offset_of!(b2ContactHitEvent, point) - 16usize];
    ["Offset of field: b2ContactHitEvent::normal"]
        [::std::mem::offset_of!(b2ContactHitEvent, normal) - 24usize];
...
const _: () = {
    ...
    ["Offset of field: b2ContactEvents::beginEvents"]
        [::std::mem::offset_of!(b2ContactEvents, beginEvents) - 0usize];
    ["Offset of field: b2ContactEvents::endEvents"]
        [::std::mem::offset_of!(b2ContactEvents, endEvents) - 8usize];
    ["Offset of field: b2ContactEvents::hitEvents"]
        [::std::mem::offset_of!(b2ContactEvents, hitEvents) - 16usize];
    ["Offset of field: b2ContactEvents::beginCount"]
        [::std::mem::offset_of!(b2ContactEvents, beginCount) - 24usize];
    ["Offset of field: b2ContactEvents::endCount"]
        [::std::mem::offset_of!(b2ContactEvents, endCount) - 28usize];
    ["Offset of field: b2ContactEvents::hitCount"]
        [::std::mem::offset_of!(b2ContactEvents, hitCount) - 32usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2BodyMoveEvent::userData"]
        [::std::mem::offset_of!(b2BodyMoveEvent, userData) - 0usize];
    ["Offset of field: b2BodyMoveEvent::transform"]
        [::std::mem::offset_of!(b2BodyMoveEvent, transform) - 8usize];
    ["Offset of field: b2BodyMoveEvent::bodyId"]
        [::std::mem::offset_of!(b2BodyMoveEvent, bodyId) - 24usize];
    ["Offset of field: b2BodyMoveEvent::fellAsleep"]
        [::std::mem::offset_of!(b2BodyMoveEvent, fellAsleep) - 32usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2BodyEvents::moveEvents"]
        [::std::mem::offset_of!(b2BodyEvents, moveEvents) - 0usize];
    ["Offset of field: b2BodyEvents::moveCount"]
        [::std::mem::offset_of!(b2BodyEvents, moveCount) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2JointEvent::jointId"]
        [::std::mem::offset_of!(b2JointEvent, jointId) - 0usize];
    ["Offset of field: b2JointEvent::userData"]
        [::std::mem::offset_of!(b2JointEvent, userData) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2JointEvents::jointEvents"]
        [::std::mem::offset_of!(b2JointEvents, jointEvents) - 0usize];
    ["Offset of field: b2JointEvents::count"]
        [::std::mem::offset_of!(b2JointEvents, count) - 8usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2ContactData::contactId"]
        [::std::mem::offset_of!(b2ContactData, contactId) - 0usize];
    ["Offset of field: b2ContactData::shapeIdA"]
        [::std::mem::offset_of!(b2ContactData, shapeIdA) - 12usize];
    ["Offset of field: b2ContactData::shapeIdB"]
        [::std::mem::offset_of!(b2ContactData, shapeIdB) - 20usize];
    ["Offset of field: b2ContactData::manifold"]
        [::std::mem::offset_of!(b2ContactData, manifold) - 28usize];
};
...
const _: () = {
    ...
    ["Offset of field: b2DebugDraw::DrawPolygonFcn"]
        [::std::mem::offset_of!(b2DebugDraw, DrawPolygonFcn) - 0usize];
    ["Offset of field: b2DebugDraw::DrawSolidPolygonFcn"]
        [::std::mem::offset_of!(b2DebugDraw, DrawSolidPolygonFcn) - 8usize];
    ["Offset of field: b2DebugDraw::DrawCircleFcn"]
        [::std::mem::offset_of!(b2DebugDraw, DrawCircleFcn) - 16usize];
    ...
    ["Offset of field: b2DebugDraw::DrawSegmentFcn"]
        [::std::mem::offset_of!(b2DebugDraw, DrawSegmentFcn) - 40usize];
    ["Offset of field: b2DebugDraw::DrawTransformFcn"]
        [::std::mem::offset_of!(b2DebugDraw, DrawTransformFcn) - 48usize];
    ["Offset of field: b2DebugDraw::DrawPointFcn"]
        [::std::mem::offset_of!(b2DebugDraw, DrawPointFcn) - 56usize];
    ["Offset of field: b2DebugDraw::DrawStringFcn"]
        [::std::mem::offset_of!(b2DebugDraw, DrawStringFcn) - 64usize];
    ["Offset of field: b2DebugDraw::drawingBounds"]
        [::std::mem::offset_of!(b2DebugDraw, drawingBounds) - 72usize];
    ["Offset of field: b2DebugDraw::drawShapes"]
        [::std::mem::offset_of!(b2DebugDraw, drawShapes) - 88usize];
    ["Offset of field: b2DebugDraw::drawJoints"]
        [::std::mem::offset_of!(b2DebugDraw, drawJoints) - 89usize];
    ["Offset of field: b2DebugDraw::drawJointExtras"]
        [::std::mem::offset_of!(b2DebugDraw, drawJointExtras) - 90usize];
    ["Offset of field: b2DebugDraw::drawBounds"]
        [::std::mem::offset_of!(b2DebugDraw, drawBounds) - 91usize];
    ["Offset of field: b2DebugDraw::drawMass"]
        [::std::mem::offset_of!(b2DebugDraw, drawMass) - 92usize];
    ["Offset of field: b2DebugDraw::drawBodyNames"]
        [::std::mem::offset_of!(b2DebugDraw, drawBodyNames) - 93usize];
    ["Offset of field: b2DebugDraw::drawContacts"]
        [::std::mem::offset_of!(b2DebugDraw, drawContacts) - 94usize];
    ["Offset of field: b2DebugDraw::drawGraphColors"]
        [::std::mem::offset_of!(b2DebugDraw, drawGraphColors) - 95usize];
    ...
    ["Offset of field: b2DebugDraw::drawIslands"]
        [::std::mem::offset_of!(b2DebugDraw, drawIslands) - 100usize];
    ["Offset of field: b2DebugDraw::context"]
        [::std::mem::offset_of!(b2DebugDraw, context) - 104usize];
};
extern "C" {
